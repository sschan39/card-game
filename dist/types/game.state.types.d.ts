 ...
 */
export type GameStateName = 'waiting' | 'RPS' | 'stateTurnStart' | 'stateDrawPhase' | 'stateMainPhase' | 'stateBattlePhase' | 'endCombat' | 'stateEndPhase' | 'cleanupStep' | 'Stack' | 'gameOver';
